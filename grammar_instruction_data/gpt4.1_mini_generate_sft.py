...
client = OpenAI(api_key=r'your key')
            ...
            messages=[
                {
                    ...
                    "content": [
                        {
                            "text": '你是一位经验丰富的中文写作教学专家，擅长设计写作型语法教学任务。',
                            "type": "text"
                        }
                    ]
                },
...
def main_fn(df_dict,prompt):
    ...
    outjsonl = open(f'2.gpt对目标语法点生成sft数据/gptmini4.1_教学指令数据生成0626.jsonl', 'a+', encoding='utf-8')
    ...
    result_df.to_excel(f'2.gpt对目标语法点生成sft数据/gptmini4.1_教学指令数据生成0626.xlsx', index=False)
